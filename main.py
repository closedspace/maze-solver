import constants
from tkinter import YES, Tk, BOTH, Canvas
...
def main():
    ...
    maze = Maze(10, 10, 600, 600)

    maze.generate_maze_prims()

    iterator = maze.bfs_solve(win.canvas)
    maze.animate_iterator(win.canvas, iterator)

    maze.draw_grid(win.canvas)
